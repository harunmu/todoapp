        ...
        <div className="bg-white w-96 p-5 text-sm rounded-lg shadow-xl">
                {isOpen?(
                    <div className='flex'>
                        ...
                        <div className='mx-2 flex flex-col text-gray-800 text-xs font-light '>
                            ...
                            <button className='border-b-1 border-gray-300 hover:text-red-300 hover:border-red-300 hover:font-normal' onClick={handleDelete}>削除</button>
                        </div>
                        )}
                ...
                {isEditing?(
                    <input 
                        ref = {ref}
                        type="text"
                        className="border-dashed pr-20 w-full text-center font-bold mb-5 text-2xl text-blue-300 border-b-2 border-gray-400 focus:outline-none"
